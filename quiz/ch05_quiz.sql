-- Active: 1749600516352@@127.0.0.1@3306@quiz
-- 1. 자료형 확인 문제
...
-- 정답: id 값이 곧 인원수 만큼 이기 때문에 적당히 작은 숫자범위면 충분
-- SMALLINT는 2바이트로 65,535까지 정수를 저장할수 있다
...
-- 정답: 고정 소수점방식으로 총 5자리중 2자리는 소수자리
...
-- 정답: 데이터를 표현할수 있는 범위의 차이가 있어서 정확성이 다르다
...
FROM events
WHERE (event_date BETWEEN '2023-10-01' AND '2023-12-31')AND HOUR(start_time)>=14;
